...
class _PostCardState extends State<PostCard> {
  ...
  final List<Map<String, dynamic>> _reactions = [
    {'asset': 'like.png', 'color': Colors.blue}, // Like
    {'asset': 'heart.png', 'color': Colors.red}, // Love
    {'asset': 'haha.png', 'color': Colors.orange}, // Haha
    {'asset': 'surprised.png', 'color': Colors.amber}, // Wow
    {'asset': 'sad.png', 'color': Colors.indigo}, // Sad
    {'asset': 'angry.png', 'color': Colors.deepOrange}, // Angry
  ];
