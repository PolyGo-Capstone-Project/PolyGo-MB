...
class UpdateSpeakingLanguage extends StatefulWidget {
  ...
  @override
  State<UpdateSpeakingLanguage> createState() => _UpdateSpeakingLanguageState();
}
...
class _UpdateSpeakingLanguageState extends State<UpdateSpeakingLanguage> {
  ...
  Future<void> _fetchLanguages({String? lang}) async {
    try {
      ...
      final langs = await _repo.getSpeakingLanguagesMeAll(
        token,
        lang: lang ?? 'vi',
      );
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  loc.translate("choose_langs_you_know"),
                  textAlign: TextAlign.center,
